...
class SettingsFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'methods' => 'map[string,\Ory\Kratos\Client\Model\SettingsFlowMethod]',
        'requestUrl' => 'string',
        'state' => 'string',
        'type' => 'string'
    ];
     ...
     * Gets methods
     *
     * @return map[string,\Ory\Kratos\Client\Model\SettingsFlowMethod]
     */
     ...
     * Sets methods
     *
     * @param map[string,\Ory\Kratos\Client\Model\SettingsFlowMethod] $methods Methods contains context for all enabled registration methods. If a settings flow has been processed, but for example the first name is empty, this will contain error messages.
     *
     * @return self
     */

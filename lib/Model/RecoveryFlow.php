...
class RecoveryFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'methods' => 'map[string,\Ory\Kratos\Client\Model\RecoveryFlowMethod]',
        'requestUrl' => 'string',
        'state' => 'string',
        'type' => 'string'
    ];
     ...
     * Gets methods
     *
     * @return map[string,\Ory\Kratos\Client\Model\RecoveryFlowMethod]
     */
     ...
     * Sets methods
     *
     * @param map[string,\Ory\Kratos\Client\Model\RecoveryFlowMethod] $methods Methods contains context for all account recovery methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages.
     *
     * @return self
     */

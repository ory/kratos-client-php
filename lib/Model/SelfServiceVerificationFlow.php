...
class SelfServiceVerificationFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'issuedAt' => '\DateTime',
        'requestUrl' => 'string',
        'state' => '\Ory\Kratos\Client\Model\SelfServiceVerificationFlowState',
        'type' => 'string',
     ...
     * Gets state
     *
     * @return \Ory\Kratos\Client\Model\SelfServiceVerificationFlowState
     */
     ...
     * Sets state
     *
     * @param \Ory\Kratos\Client\Model\SelfServiceVerificationFlowState $state state
     *
     * @return self
     */

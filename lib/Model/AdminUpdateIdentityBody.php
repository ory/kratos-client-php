...
class AdminUpdateIdentityBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets schemaId
     *
     * @param string|null $schemaId SchemaID is the ID of the JSON Schema to be used for validating the identity's traits. If set will update the Identity's SchemaID.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Ory\Kratos\Client\Model\IdentityState
     */
     ...
     * Sets state
     *
     * @param \Ory\Kratos\Client\Model\IdentityState $state state
     *
     * @return self
     */

...
class IdentityApi
{
     ...
     * @return void
     */
    public function deleteIdentityCredentials($id, $type, string $contentType = self::contentTypes['deleteIdentityCredentials'][0])
    {
        $this->deleteIdentityCredentialsWithHttpInfo($id, $type, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteIdentityCredentialsWithHttpInfo($id, $type, string $contentType = self::contentTypes['deleteIdentityCredentials'][0])
    {
        $request = $this->deleteIdentityCredentialsRequest($id, $type, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteIdentityCredentialsAsync($id, $type, string $contentType = self::contentTypes['deleteIdentityCredentials'][0])
    {
        return $this->deleteIdentityCredentialsAsyncWithHttpInfo($id, $type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteIdentityCredentialsAsyncWithHttpInfo($id, $type, string $contentType = self::contentTypes['deleteIdentityCredentials'][0])
    {
        $returnType = '';
        $request = $this->deleteIdentityCredentialsRequest($id, $type, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteIdentityCredentialsRequest($id, $type, string $contentType = self::contentTypes['deleteIdentityCredentials'][0])
    {

...
class PublicApi
{
     ...
     * @param  string $request Request is the request ID.  type: string (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function completeSelfServiceBrowserProfileManagementFlow($body, $request = null)
    {
        $this->completeSelfServiceBrowserProfileManagementFlowWithHttpInfo($body, $request);
    }
     ...
     */
    public function completeSelfServiceBrowserProfileManagementFlowWithHttpInfo($body, $request = null)
    {
        $request = $this->completeSelfServiceBrowserProfileManagementFlowRequest($body, $request);
     ...
     */
    public function completeSelfServiceBrowserProfileManagementFlowAsync($body, $request = null)
    {
        return $this->completeSelfServiceBrowserProfileManagementFlowAsyncWithHttpInfo($body, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function completeSelfServiceBrowserProfileManagementFlowAsyncWithHttpInfo($body, $request = null)
    {
        $returnType = '';
        $request = $this->completeSelfServiceBrowserProfileManagementFlowRequest($body, $request);
     ...
     */
    protected function completeSelfServiceBrowserProfileManagementFlowRequest($body, $request = null)
    {
